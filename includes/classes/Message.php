...
public function getLatestMessage($userLoggedIn, $user2) {
  ...
  $start_date = new DateTime($row['date']); //Times posted
  ...
  else if($interval->h >= 20) {
    if($interval->h == 1) {
      $time_message = $interval->h . "Recent";
    }
    else {
...
public function getConvos() {
  ...
  foreach($convos as $username) {
    ...
    <img src='" . $user_found_obj->getProfilePic() . "' style='border-radius: 5px; margiin-right: 5px;'>

...
if(isset($_POST['update_details'])) {
	...
	if($matched_user == "" || $matched_user == $userLoggedIn) {
		$message = "Your details were updated<br><br>";
          	...
          	if(md5($old_password) == $db_password) {
          		...
          		if($new_password_1 == $new_password_2) {
          			...
          			if(strlen($new_password_1) <= 4) {
          				$password_message = "Please enter a password longer than 4 characters<br><br>";
          			}
          			...
          			$password_message = "Your two new passwords do not match!<br><br>";
          		}

          	}
          	else {
          			$password_message = "Unfortunately, you have provided an incorrect old password<br><br>";
          	}
